...
public class MarcacoesFeitasDao {
     ...
     public void creat(MarcacoesFeitas c){
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO ponto.marcacoesfeitas (entrada,saida) VaLUES(?,?)");
    ...
    public List<MarcacoesFeitas> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM ponto.marcacoesfeitas");
    ...
    public void update(MarcacoesFeitas c){
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE ponto.marcacoesfeitas SET entrada = ?,saida = ? WHERE id = ?");
            stmt.setString(1,c.getEntrada());
            stmt.setString(2,c.getSaida());
            stmt.setString(3,c.getId().toString());
    ...
    public void delete(MarcacoesFeitas c){
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM ponto.marcacoesfeitas WHERE id = ?");
    ...
    public int Count(){
        ...
        try {
            stmt = con.prepareStatement("SELECT COUNT(*) FROM ponto.marcacoesfeitas");
            rs = stmt.executeQuery();
